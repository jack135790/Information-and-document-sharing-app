...
<body>
    ...
    <?php
        ...
        function update() {
				...
				if (mysqli_query($conn, $sql)) {
                    ...
                    header("refresh:3;url=http://localhost/IDS/home.php?page=attendance.php");
				}
				else {
	...
	function fetch() {
		...
		echo "<div class=\"table\"><table><tr><th>Name</th><th>Class-Div-Roll</th><th>TOC</th><th>WT-T</th><th>WT-P</th><th>DE</th><th>SE-T</th><th>SE-P</th><th>DOTNET-T</th><th>DOTNET-P</th><th>AJ-P</th><th>AJ-T</th><th>Atten-ded</th><th>Total</th><th>Perce-ntage</th><th>Update</th></tr>";
